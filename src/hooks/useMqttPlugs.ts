  ...
  const sendOta = useCallback((uuid: string, kind: "tasmota" | "custom"): boolean => {
    ...
    const url = kind === "tasmota"
      ? (family === "esp02s"
          ...
          : `http://gym907-0001.iptime.org/ota/tasmota/esp8685/lite/esp8685_tasmota_lite.bin`)
      : (family === "esp02s"
          ? `http://gym907-0001.iptime.org/ota/tasmota/esp02s/custom/esp02s_custom.bin.gz`
          : `http://gym907-0001.iptime.org/ota/tasmota/esp8685/custom/esp8685_custom.bin`);
